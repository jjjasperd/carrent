 ...
 * @Description com.user registation dto
...
public class UserRegistrationDTO implements Serializable {
    ...
    /**
     * input com.user password
     * max length:32
     */
    @NotBlank(message = "userPassword can not be blank.")
     ...
     */
    @NotBlank(message = "com.user driver license id can not be blank.")
